    ...
    return (
        <Box w="100%" h={{ base: "60vh", md: "80vh", lg: "90vh" }} bgImage={StudyPict.src} bgRepeat="no-repeat" bgSize="cover" zIndex={0} pos="relative">
            ...
            <Flex
                ...
                align="center"
                textAlign="center"
                px={{ base: "4%", md: "10%" }} // Menambahkan padding horizontal untuk perangkat kecil
            >
                ...
                <Button
                    p={{ base: "12px", md: "32px" }} // Mengurangi padding pada perangkat kecil
                    mt="2%"
                    zIndex="99"
                    fontSize={buttonFontSize}
                    w={{ base: "160px", md: "200px", lg: "260px" }} // Ukuran tombol lebih kecil di perangkat kecil
                    bg="purple.300"
                    borderRadius="md"
                    fontWeight="bold"
                    color="white"
